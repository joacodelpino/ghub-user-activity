...
> Basado en: [https://roadmap.sh/projects/github-user-activity](https://roadmap.sh/projects/github-user-activity)
...
cd ghub-user-activity
bun install
```

### Uso
```bash
bun run index.ts <nombre-de-usuario>
```

### Ejemplo
```bash
bun run index.ts kamranahmedse
```